...
from utils.sampling import mnist_iid, mnist_noniid, cifar_iid, svhn_iid, svhn_noniid
...
def forget_with_generated_data(global_model, generator, device, TARGET_CLASS_INDEX, num_classes,
                               noise_dim=100, num_steps=20000, batch_size=64):
    global_model.train()
    optimizer = optim.SGD(global_model.parameters(), lr=0.0016, momentum=0.9)
...
if __name__ == '__main__':
    ...
    generator = train_generator(generator, net_glob, args.device, TARGET_CLASS_INDEX, num_classes=num_classes,
                                noise_dim=NOISE_DIM, num_steps=20000, batch_size=64)
